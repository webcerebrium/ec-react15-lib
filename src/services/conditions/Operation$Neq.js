...
export const Operation$Neq = (cond, context) => {
  Logger.of('Operation.$Neq').info('condition=', cond, 'context=', context);
  if (!checkProperties({
  ...
  Logger.of('Operation.$Neq').info('comparing op1=', op1, 'and op2=', op2, 'cond=', cond);
  return op1 !== op2;
};

export default { Operation$Neq };
