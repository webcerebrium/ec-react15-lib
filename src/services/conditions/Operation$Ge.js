...
export const Operation$Ge = (cond, context) => {
  Logger.of('Operation.$Ge').info('condition=', cond, 'context=', context);
  if (!checkProperties({
  ...
  Logger.of('Operation.$Ge').info('comparing op1=', op1, 'and op2=', op2, 'cond=', cond);
  return op1 >= op2;
};

export default { Operation$Ge };
