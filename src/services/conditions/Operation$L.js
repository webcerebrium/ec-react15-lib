...
export const Operation$L = (cond, context) => {
  Logger.of('Operation.$L').info('condition=', cond, 'context=', context);
  if (!checkProperties({
  ...
  Logger.of('Operation.$L').info('comparing op1=', op1, 'and op2=', op2, 'cond=', cond);
  return op1 < op2;
};

export default { Operation$L };
